<template>
  <header class="lg:w-full" style="background-color: #FEFDEC;">
    <transition name="fade-up"
      ...
      <div
        id="menu"
        class="w-full fixed w-screen h-screen top-0 left-0 p-8 lg:px-6 box-border lg:w-full 2xl:p-12 lg:h-auto z-10"
        v-show="mobileMenuOpen"
        style="background-color: #FEFDEC;"
      >
        <nav class="p-0">
          <ul>
            <li>
              <nuxt-link id="home-link" class="block" to="/"
                >Jack Murray-Brown</nuxt-link
              >
            </li>
            <li>
            ...
            <li>
              <a class="block" href="mailto:jack@antiantivirus.co.uk"
                >Mail Me</a
              >
            </li>
            <li>
    ...
    <div class="fixed bottom-0 left-0 w-screen p-8 box-border lg:hidden z-20">
      <button class="w-full " @click="mobileMenuOpen = !mobileMenuOpen">
        {{ mobileMenuText }}
      </button>
    </div>
  </header>

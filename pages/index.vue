<template>
  <div>
    <div class="relative h-full">
      <img width="444" height="314" class="lg:hidden max-w-md mx-auto block mb-32" src="~assets/images/JMB-mobile.svg" alt=""/>
      <img width="1192" height="460" class="hidden lg:block xl:-mb-16 2xl:-mb-72 max-w-screen-xl mx-auto" src="~assets/images/JMB.svg" alt=""/>

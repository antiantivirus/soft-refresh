<template>
  <div>
    ...
    <div class="grid md:grid-cols-2 xl:grid-cols-3 gap-8 mb-24 lg:mb-0 md:gap-x-6 md:gap-y-12 seriously-selected-grid">
      ...
      <div>
        <a href="https://www.are.na/jack-murray-brown/community-archives-and-shared-infrastructures" target="_blank"
          ...
          <div class="p-4">
            <h4 class="m-0">
              Community Archives and Shared Infrastructures workshop for International Community Radio Network (ICRN).
            </h4>
          </div>
        </a>
      </div>
      <div style="background-color: #FAC898" class="flex items-end border-me">
        <div class="p-4">
          <h4 class="m-0">
            Web development for Radio Dopo, a new community radio station due to launch in Palermo, Italy later this
            year.
          </h4>
        </div>
      </div>
      <div>
        <nuxt-link to="/work/fruitful-fm" class="border-me homepage-item" style="background-color: #91CC8F">
          ...
          <div class="p-4">
            <h4 class="m-0">
              Fruitful.FM - A radio station housed inside a greenhouse. Flipping the
      ...
      <div>
        <nuxt-link to="/work/norbergfestival-radio" class="border-me homepage-item" style="background-color: #8BD3E6">
          ...
          <div class="p-4">
            <h4 class="m-0">
              Radio Co-ordinator for Norbergfestival, a temporary radio station
              broadcasting from a former iron mine in Sweden.
            </h4>
          </div>
        </nuxt-link>
      </div>
    ...
    <p class="mb-4 max-w-prose">
      Jack Murray-Brown is a developer, artist and radio enthusiast. He is
      currently based in Berlin and has been working in web development and radio for over 6 years.
    </p>
    <p class="my-12">. ݁₊ ⊹ . ݁ ⟡ ݁ . ⊹ ₊ ݁.</p>
